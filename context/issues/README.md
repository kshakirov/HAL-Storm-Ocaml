...
Дата синхронизации: 2026-09-18
Источник: https://github.com/kshakirov/HAL-Storm-Ocaml/issues

## Открытые

- [#2 — Реализация матрицы переходов ДКА Вирта](0002.md)
...
- [#8 — Исследовать потоковый protobuf-декодер как основу DRPC](0008.md)

## Закрытые

- [#1 — Проектирование типов срезов и токенов (`ByteSlice`)](0001.md)
- [#3 — Сборка структуры `HttpRequestLine`](0003.md)
